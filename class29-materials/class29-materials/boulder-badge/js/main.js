...
let totalCandies = bulbasaurCandies +
...
function battleCondition(currentTemp){
    let converted = checkTemp(currentTemp);
    if (converted > 0){
...
function battleSelector(pokemon){
...
battleSelector(['bulba','pikachu','charmander'])